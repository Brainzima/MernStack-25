  ...
  return (
    <>
      <div className="container bg-light p-5 rounded-5">
        ...
        <h4 className='text-center'>Total Questions: {questions.length}</h4>
        <hr />
        {
          isActive ?
            <div className="container">
              <div className="card">
                <div className="card-body text-center">
                  <h1>Scored {score} / {questions.length}</h1>

                  <button className='btn btn-secondary' onClick={resetQuiz}>Try Again</button>
                </div>
              </div>
            </div>
            :
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="card-text">
                    {
                      questions[currentQ].answers.map((options, index) => (
                        <div key={index}>
                        <button  onClick={()=>handleCheck(options.isCorrect)} className='btn btn-outline-dark mt-1'>
                          {options.answer}
                        </button> 
                        </div>
                      ))
